              ...
              <Card className="introduction" variant="outlined">
                <CardContent style={{ padding: "15px" }}>
                  <Typography variant="body1">
                    ...
                    Virginia (CSA@UVA), as one of the largest Asian-American
                    cultural organizations on grounds, seeks to promote
                    awareness and appreciation for Chinese culture within the
                    University and greater Charlottesville community.
                  </Typography>
                  <div
                    className="socials"
