      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            text={"Join CSA, VSA, and OYFA for a relaxing musical charity event to benefit National Alliance on Mental Illness, Asian Prisoner Support Committee, and Philippines Relief Fund. We will be presenting mainly musical performances from members of these organizations. Coffee will be provided."}
            style={cardStyle} 
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
        ...
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            text={"UVA is proud to host W&M, VT, and VCU for ChinaVAsian 2022, an annual event that brings together the Chinese Student Organizations from colleges across Virginia. There will be performances, sports, and activities for the members of each school to interact and get to know each other!"}
            style={cardStyle} 
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            text={"We're back again, so get ready for a Valentine themed ice breaker! Bring your friends and/or significant other to have some fun and learn about upcoming events!"}
            style={cardStyle} 
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            text={"Come to Chinafest Showcase to preview some of the dances you can participate in for our annual Chinafest performance! Our talented choreographers have been preparing some awesome dances, so this is definitely an event you don't want to miss!"}
            style={cardStyle} 
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
