      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            text={"Come out to play some CSA/UVA themed Jeopardy! We'll play in teams of five but you do not need a team to sign up! There will be a prize of $50 for the winning team!"}
            style={cardStyle} 
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            text={"Sign up to participate in MyTie - you will be paired with another member to play games against other pairs!! The winning pair will each receive a $10 GrubHub gift card :))"}
            style={cardStyle} 
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            text={"Come out to our resume workshop to get your resume reviewed by fellow CSA members and alumni! We hope you all take advantage of this opportunity to expand your knowledge and learn from others in our community!"}
            style={cardStyle} 
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            text={"We hope everyone had a restful and safe winter break!! Come out to our first general meeting of the semester to learn about upcoming events and see some familiar faces ♥"}
            style={cardStyle} 
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            text={"Chinafest season is almost here! Come to our Chinafest Showcase to preview some of the dances and acts you can participate in for our annual Chinafest performance, which will be online this year! Our talented choreographers have been preparing some great dances so this is definitely an event you don't want to miss!"}
            style={cardStyle} 
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            text={"Come out to Masterclass Mondays to learn new skills, recipes, and quarantine activities from members of the CSA community! Classes will be held on zoom every Monday from December 21st to January 25th!! Hope to see you there :))"}
            style={cardStyle} 
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
