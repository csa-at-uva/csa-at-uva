      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            text={"Come be CSA's valentine at our February General Body Meeting to learn more about all the events coming up ~ ♥"}
            style={cardStyle} 
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            text={"Come kickstart the beginning of the new semester at a show featuring a special guest, mentalist and magician David Feng! David Feng, who graduated from UVA in 2015, will be performing magic, as well as talking about his unique journey on how he became a magician. As an award-winning Asian-American magician, David is especially passionate in sharing his work of magic with the Asian community."}
            style={cardStyle} 
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            text={"Hope everyone enjoyed and had a restful break! Bet you miss CSA a bit so come join us for CSA's first general body meeting of the new decade! Come for our fun icebreaker and learn more about our upcoming events for this month!"}
            style={cardStyle} 
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
