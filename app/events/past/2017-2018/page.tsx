      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            text={"Wow time really flies! Come to the last general body meeting with the current (2017-2018) officer board. We will also go over some of the events going on in March including Spring Family Month so you don't want to miss out!"}
            style={cardStyle} 
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
        ...
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            text={"Inspired by the Chinese TV show “If You Are the One”, MSN will present this annual dating event with KSA, CSA and OYFA in January 19th, 2018. Click HERE to watch our promotion video for If You Are the One: https://m.youtube.com/watch?v=9mF8gFfarRo"}
            style={cardStyle} 
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
