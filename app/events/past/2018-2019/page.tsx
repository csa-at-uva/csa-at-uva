      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            text={"Thought we were done after Chinafest? Well, think again! We still have a lot of events left in store for y'all! Keep up to date with us as we talk about Spring Family Month, elections, and other cool events you don't want to miss out on!!"}
            style={cardStyle}
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
        ...
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            text={"Can't believe it's February already? Come be CSA's valentine at our February general body meeting on Wednesday Feb.6th in Clark 107 and learn about everything we have in store for you this month ❤"}
            style={cardStyle}
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            text={"Welcome back from break everyone~ I hope y'all are well rested and are ready to jump back in with CSA! Come to our January general body meeting this Wednesday (Jan.16th) in Clark 107 to learn about all the upcoming events we have for you!!"}
            style={cardStyle}
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
