      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            subheading="Jan 21, 2023 | O'Hill Forum"
            text={"Come celebrate Lunar New Year with us! Learn about the significance of Lunar New Year while having doing some fun activities and maybe even free munchies!"}
            style={cardStyle} 
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            text={"HELLO HELLO HELLO! Hope y'all had a good break! To kick off the school year, come out to our FIRST GBM of the semester and find out what exciting things we have planned! There's so much to do (cough cough CHINAFEST), so be sure to not miss it! "}
            style={cardStyle} 
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            text={"Come to our LAST GBM of the semester! Get ready for the holidays with us and get a sneak peek into what's happening next semester! ALSO come pick up your Santagrams and exchange Secret Santa gifts!"}
            style={cardStyle} 
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
        ...
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <EventCard
            ...
            text={"Chinaball is CSA's annual 3v3 basketball tournament for charity, and this year, it will be held November 13th at Memorial Gym courts 1 & 2 from 3-6:30PM."}
            style={cardStyle} 
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
