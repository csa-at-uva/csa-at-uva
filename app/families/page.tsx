      ...
      >
        <SwiperSlide>
          ...
          <div style={{ display: "flex", justifyContent: "center" }}>
            <Image
              src={cranes}
              alt="Cranes' family picture at Sunset Series"
              height={375}
            />
            <InstagramEmbed
              url="https://www.instagram.com/p/C_s1qT2RZy4/"
              height={375}
            />
          </div>
        </SwiperSlide>
        <SwiperSlide>
          ...
          <div style={{ display: "flex", justifyContent: "center" }}>
            <Image
              src={eagles}
              alt="Eagles' family picture at Sunset Series"
              height={375}
            />
            <InstagramEmbed
              url="https://www.instagram.com/p/C_qkcHtR6V1/"
              height={375}
            />
          </div>
        </SwiperSlide>
        <SwiperSlide>
          ...
          <div style={{ display: "flex", justifyContent: "center" }}>
            <Image
              src={swans}
              alt="Swans' family picture at Sunset Series"
              height={375}
            />
            <InstagramEmbed
              url="https://www.instagram.com/p/C_tZTNUpvA7/?img_index=7"
              height={375}
            />
          </div>
        </SwiperSlide>
